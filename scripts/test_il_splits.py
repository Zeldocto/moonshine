...
class SplitContractTests(unittest.TestCase):
    ...
    def test_kernel_uses_atomic_ab_and_serial_service(self) -> None:
        ...
        self.assertIn("moonshine_il_stats_v8_a.bin", source)
        self.assertIn("moonshine_il_stats_v8_b.bin", source)
        self.assertIn("moonshine_il_stats_v7_a.bin", source)
        self.assertIn("moonshine_il_stats_v7_b.bin", source)
        self.assertIn("moonshine_il_stats_v6_a.bin", source)
        self.assertIn("moonshine_il_stats_v6_b.bin", source)
        self.assertIn("moonshine_il_stats_v5_a.bin", source)
        self.assertIn("moonshine_il_stats_v5_b.bin", source)
        self.assertIn("moonshine_il_stats_v4_a.bin", source)
        self.assertIn("moonshine_il_stats_v4_b.bin", source)
        self.assertIn("moonshine_il_stats_v3_a.bin", source)
        self.assertIn("moonshine_il_stats_v3_b.bin", source)
        self.assertIn("moonshine_il_stats_v2_a.bin", source)
        self.assertIn("moonshine_il_stats_v2_b.bin", source)
        self.assertIn("moonshine_il_stats_v1_a.bin", source)
        self.assertIn("moonshine_il_stats_v1_b.bin", source)
