...
class PlaylistFormatTests(unittest.TestCase):
    ...
    def test_shared_constants_offsets_and_safe_journal_paths(self) -> None:
        ...
        self.assertIn("moonshine_stage_playlists_v2_a.bin", kernel)
        self.assertIn("moonshine_stage_playlists_v2_b.bin", kernel)
        self.assertIn("moonshine_stage_playlists_v1_a.bin", kernel)
        self.assertIn("moonshine_stage_playlists_v1_b.bin", kernel)
